...
var FragmentFactory = /** @class */function () {
  ...
  FragmentFactory.prototype.createNewInstance = function (fileName) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _android_widget_EditTextImpl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./android/widget/EditTextImpl */ "./src/android/widget/EditTextImpl.ts");
/* harmony import */ var _android_widget_FrameLayoutImpl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./android/widget/FrameLayoutImpl */ "./src/android/widget/FrameLayoutImpl.ts");
...
var Index = /** @class */function (_super) {
  ...
  }), __metadata("design:type", _android_widget_FrameLayoutImpl__WEBPACK_IMPORTED_MODULE_1__.FrameLayout)], Index.prototype, "previewPane", void 0);
  __decorate([(0,_app_Fragment__WEBPACK_IMPORTED_MODULE_2__.Inject)({
...
/***/ "./src/android/widget/EditTextImpl.ts":
/*!********************************************!*\
  !*** ./src/android/widget/EditTextImpl.ts ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EditText": function() { return /* binding */ EditText; },
/* harmony export */   "EditTextImpl": function() { return /* binding */ EditTextImpl; },
/* harmony export */   "ImeOptionsTransformer": function() { return /* binding */ ImeOptionsTransformer; },
/* harmony export */   "InputTypeTransformer": function() { return /* binding */ InputTypeTransformer; },
/* harmony export */   "NumericTransformer": function() { return /* binding */ NumericTransformer; },
...
var ImeOptionsTransformer = /** @class */function () {
  function ImeOptionsTransformer() {}
  ImeOptionsTransformer.prototype.transform = function (value, obj, type) {
    if (type == 1) {
      ...
      for (var i = 0; i < strArray.length; i++) {
        switch (strArray[i]) {
          case "actionDone":
            valueArr.push("actionDone" /* ImeOptions.actionDone */);
            break;
          case "actionGo":
            valueArr.push("actionGo" /* ImeOptions.actionGo */);
            break;
          case "actionNext":
            valueArr.push("actionNext" /* ImeOptions.actionNext */);
            break;
          case "actionNone":
            valueArr.push("actionNone" /* ImeOptions.actionNone */);
            break;
          case "actionPrevious":
            valueArr.push("actionPrevious" /* ImeOptions.actionPrevious */);
            break;
          case "actionSearch":
            valueArr.push("actionSearch" /* ImeOptions.actionSearch */);
            break;
          case "actionSend":
            valueArr.push("actionSend" /* ImeOptions.actionSend */);
            break;
          case "actionUnspecified":
            valueArr.push("actionUnspecified" /* ImeOptions.actionUnspecified */);
            break;
          case "flagForceAscii":
            valueArr.push("flagForceAscii" /* ImeOptions.flagForceAscii */);
            break;
          case "flagNavigateNext":
            valueArr.push("flagNavigateNext" /* ImeOptions.flagNavigateNext */);
            break;
          case "flagNavigatePrevious":
            valueArr.push("flagNavigatePrevious" /* ImeOptions.flagNavigatePrevious */);
            break;
          case "flagNoAccessoryAction":
            valueArr.push("flagNoAccessoryAction" /* ImeOptions.flagNoAccessoryAction */);
            break;
          case "flagNoEnterAction":
            valueArr.push("flagNoEnterAction" /* ImeOptions.flagNoEnterAction */);
            break;
          case "flagNoExtractUi":
            valueArr.push("flagNoExtractUi" /* ImeOptions.flagNoExtractUi */);
            break;
          case "flagNoFullscreen":
            valueArr.push("flagNoFullscreen" /* ImeOptions.flagNoFullscreen */);
            break;
          case "flagNoPersonalizedLearning":
            valueArr.push("flagNoPersonalizedLearning" /* ImeOptions.flagNoPersonalizedLearning */);
            break;
          case "normal":
            valueArr.push("normal" /* ImeOptions.normal */);
            break;
        }
      }
      return valueArr;
  ...
  return ImeOptionsTransformer;
}();

var InputTypeTransformer = /** @class */function () {
  function InputTypeTransformer() {}
  InputTypeTransformer.prototype.transform = function (value, obj, type) {
    if (type == 1) {
      return value.toString().replace(",", "|");
    } else {
      var strArray = value.toString().split("|");
      ...
      for (var i = 0; i < strArray.length; i++) {
        switch (strArray[i]) {
          case "date":
            valueArr.push("date" /* InputType.date */);
            break;
          case "datetime":
            valueArr.push("datetime" /* InputType.datetime */);
            break;
          case "none":
            valueArr.push("none" /* InputType.none */);
            break;
          case "number":
            valueArr.push("number" /* InputType.number */);
            break;
          case "numberDecimal":
            valueArr.push("numberDecimal" /* InputType.numberDecimal */);
            break;
          case "numberPassword":
            valueArr.push("numberPassword" /* InputType.numberPassword */);
            break;
          case "numberSigned":
            valueArr.push("numberSigned" /* InputType.numberSigned */);
            break;
          case "phone":
            valueArr.push("phone" /* InputType.phone */);
            break;
          case "text":
            valueArr.push("text" /* InputType.text */);
            break;
          case "textAutoComplete":
            valueArr.push("textAutoComplete" /* InputType.textAutoComplete */);
            break;
          case "textAutoCorrect":
            valueArr.push("textAutoCorrect" /* InputType.textAutoCorrect */);
            break;
          case "textCapCharacters":
            valueArr.push("textCapCharacters" /* InputType.textCapCharacters */);
            break;
          case "textCapSentences":
            valueArr.push("textCapSentences" /* InputType.textCapSentences */);
            break;
          case "textCapWords":
            valueArr.push("textCapWords" /* InputType.textCapWords */);
            break;
          case "textEmailAddress":
            valueArr.push("textEmailAddress" /* InputType.textEmailAddress */);
            break;
          case "textEmailSubject":
            valueArr.push("textEmailSubject" /* InputType.textEmailSubject */);
            break;
          case "textFilter":
            valueArr.push("textFilter" /* InputType.textFilter */);
            break;
          case "textImeMultiLine":
            valueArr.push("textImeMultiLine" /* InputType.textImeMultiLine */);
            break;
          case "textLongMessage":
            valueArr.push("textLongMessage" /* InputType.textLongMessage */);
            break;
          case "textMultiLine":
            valueArr.push("textMultiLine" /* InputType.textMultiLine */);
            break;
          case "textNoSuggestions":
            valueArr.push("textNoSuggestions" /* InputType.textNoSuggestions */);
            break;
          case "textPassword":
            valueArr.push("textPassword" /* InputType.textPassword */);
            break;
          case "textPersonName":
            valueArr.push("textPersonName" /* InputType.textPersonName */);
            break;
          case "textPhonetic":
            valueArr.push("textPhonetic" /* InputType.textPhonetic */);
            break;
          case "textPostalAddress":
            valueArr.push("textPostalAddress" /* InputType.textPostalAddress */);
            break;
          case "textShortMessage":
            valueArr.push("textShortMessage" /* InputType.textShortMessage */);
            break;
          case "textUri":
            valueArr.push("textUri" /* InputType.textUri */);
            break;
          case "textVisiblePassword":
            valueArr.push("textVisiblePassword" /* InputType.textVisiblePassword */);
            break;
          case "textWebEditText":
            valueArr.push("textWebEditText" /* InputType.textWebEditText */);
            break;
          case "textWebEmailAddress":
            valueArr.push("textWebEmailAddress" /* InputType.textWebEmailAddress */);
            break;
          case "textWebPassword":
            valueArr.push("textWebPassword" /* InputType.textWebPassword */);
            break;
          case "time":
            valueArr.push("time" /* InputType.time */);
            break;
        }
      }
      return valueArr;
  ...
  return InputTypeTransformer;
}();

var NumericTransformer = /** @class */function () {
  function NumericTransformer() {}
  NumericTransformer.prototype.transform = function (value, obj, type) {
    if (type == 1) {
      return value.toString().replace(",", "|");
    } else {
      var strArray = value.toString().split("|");
      ...
      for (var i = 0; i < strArray.length; i++) {
        switch (strArray[i]) {
          case "decimal":
            valueArr.push("decimal" /* Numeric.decimal */);
            break;
          case "integer":
            valueArr.push("integer" /* Numeric.integer */);
            break;
          case "signed":
            valueArr.push("signed" /* Numeric.signed */);
            break;
        }
      }
      return valueArr;
...
var EditTextImpl = /** @class */function (_super) {
  __extends(EditTextImpl, _super);
  function EditTextImpl(id, path, event) {
  ...
  EditTextImpl.prototype.tryGetCursorVisible = function () {
    ...
    if (this.cursorVisible == null || this.cursorVisible == undefined) {
      this.cursorVisible = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.isCursorVisible = function () {
    if (this.cursorVisible == null || this.cursorVisible == undefined) {
      this.cursorVisible = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.cursorVisible.getCommandReturnValue();
  };
  EditTextImpl.prototype.setCursorVisible = function (value) {
    this.resetIfRequired();
    if (this.cursorVisible == null || this.cursorVisible == undefined) {
      this.cursorVisible = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetDrawablePadding = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getDrawablePadding = function () {
    if (this.drawablePadding == null || this.drawablePadding == undefined) {
      this.drawablePadding = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.drawablePadding.getCommandReturnValue();
  };
  EditTextImpl.prototype.setDrawablePadding = function (value) {
    this.resetIfRequired();
    if (this.drawablePadding == null || this.drawablePadding == undefined) {
      this.drawablePadding = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetElegantTextHeight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.isElegantTextHeight = function () {
    if (this.elegantTextHeight == null || this.elegantTextHeight == undefined) {
      this.elegantTextHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.elegantTextHeight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setElegantTextHeight = function (value) {
    this.resetIfRequired();
    if (this.elegantTextHeight == null || this.elegantTextHeight == undefined) {
      this.elegantTextHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setEms = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.tryGetFallbackLineSpacing = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.isFallbackLineSpacing = function () {
    if (this.fallbackLineSpacing == null || this.fallbackLineSpacing == undefined) {
      this.fallbackLineSpacing = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.fallbackLineSpacing.getCommandReturnValue();
  };
  EditTextImpl.prototype.setFallbackLineSpacing = function (value) {
    this.resetIfRequired();
    if (this.fallbackLineSpacing == null || this.fallbackLineSpacing == undefined) {
      this.fallbackLineSpacing = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetFirstBaselineToTopHeight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getFirstBaselineToTopHeight = function () {
    if (this.firstBaselineToTopHeight == null || this.firstBaselineToTopHeight == undefined) {
      this.firstBaselineToTopHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.firstBaselineToTopHeight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setFirstBaselineToTopHeight = function (value) {
    this.resetIfRequired();
    if (this.firstBaselineToTopHeight == null || this.firstBaselineToTopHeight == undefined) {
      this.firstBaselineToTopHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetFreezesText = function () {
    this.resetIfRequired();
    if (this.freezesText == null || this.freezesText == undefined) {
      this.freezesText = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.isFreezesText = function () {
    if (this.freezesText == null || this.freezesText == undefined) {
      this.freezesText = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.freezesText.getCommandReturnValue();
  };
  EditTextImpl.prototype.setFreezesText = function (value) {
    this.resetIfRequired();
    if (this.freezesText == null || this.freezesText == undefined) {
      this.freezesText = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetGravity = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getGravity = function () {
    if (this.gravity == null || this.gravity == undefined) {
      this.gravity = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setGravity = function () {
    var value = [];
  ...
  EditTextImpl.prototype.tryGetHeight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getHeight = function () {
    if (this.height == null || this.height == undefined) {
      this.height = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.height.getCommandReturnValue();
  };
  EditTextImpl.prototype.setHeight = function (value) {
    this.resetIfRequired();
    if (this.height == null || this.height == undefined) {
      this.height = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetHint = function () {
    this.resetIfRequired();
    if (this.hint == null || this.hint == undefined) {
      this.hint = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.getHint = function () {
    if (this.hint == null || this.hint == undefined) {
      this.hint = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.hint.getCommandReturnValue();
  };
  EditTextImpl.prototype.setHint = function (value) {
    this.resetIfRequired();
    if (this.hint == null || this.hint == undefined) {
      this.hint = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setImeActionId = function (value) {
    this.resetIfRequired();
    if (this.imeActionId == null || this.imeActionId == undefined) {
      this.imeActionId = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setImeActionLabel = function (value) {
    this.resetIfRequired();
    if (this.imeActionLabel == null || this.imeActionLabel == undefined) {
      this.imeActionLabel = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetImeOptions = function () {
    this.resetIfRequired();
    if (this.imeOptions == null || this.imeOptions == undefined) {
      this.imeOptions = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.getImeOptions = function () {
    if (this.imeOptions == null || this.imeOptions == undefined) {
      this.imeOptions = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    this.imeOptions.setTransformer('imeOptions');
    return this.imeOptions.getCommandReturnValue();
  };
  EditTextImpl.prototype.setImeOptions = function () {
    var value = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      value[_i] = arguments[_i];
    }
  ...
  EditTextImpl.prototype.tryGetIncludeFontPadding = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.isIncludeFontPadding = function () {
    if (this.includeFontPadding == null || this.includeFontPadding == undefined) {
      this.includeFontPadding = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.includeFontPadding.getCommandReturnValue();
  };
  EditTextImpl.prototype.setIncludeFontPadding = function (value) {
    this.resetIfRequired();
    if (this.includeFontPadding == null || this.includeFontPadding == undefined) {
      this.includeFontPadding = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setInputType = function () {
    var value = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      value[_i] = arguments[_i];
    }
    ...
    if (this.inputType == null || this.inputType == undefined) {
      this.inputType = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    this.inputType.setSetter(true);
    this.inputType.setValue(value);
    this.orderSet++;
    this.inputType.setOrderSet(this.orderSet);
    this.inputType.setTransformer('inputType');
    return this.thisPointer;
  };
  EditTextImpl.prototype.tryGetLastBaselineToBottomHeight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getLastBaselineToBottomHeight = function () {
    if (this.lastBaselineToBottomHeight == null || this.lastBaselineToBottomHeight == undefined) {
      this.lastBaselineToBottomHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.lastBaselineToBottomHeight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setLastBaselineToBottomHeight = function (value) {
    this.resetIfRequired();
    if (this.lastBaselineToBottomHeight == null || this.lastBaselineToBottomHeight == undefined) {
      this.lastBaselineToBottomHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetLetterSpacing = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getLetterSpacing = function () {
    if (this.letterSpacing == null || this.letterSpacing == undefined) {
      this.letterSpacing = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.letterSpacing.getCommandReturnValue();
  };
  EditTextImpl.prototype.setLetterSpacing = function (value) {
    this.resetIfRequired();
    if (this.letterSpacing == null || this.letterSpacing == undefined) {
      this.letterSpacing = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetLineHeight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getLineHeight = function () {
    if (this.lineHeight == null || this.lineHeight == undefined) {
      this.lineHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.lineHeight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setLineHeight = function (value) {
    this.resetIfRequired();
    if (this.lineHeight == null || this.lineHeight == undefined) {
      this.lineHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetLineSpacingExtra = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getLineSpacingExtra = function () {
    if (this.lineSpacingExtra == null || this.lineSpacingExtra == undefined) {
      this.lineSpacingExtra = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.lineSpacingExtra.getCommandReturnValue();
  };
  EditTextImpl.prototype.setLineSpacingExtra = function (value) {
    this.resetIfRequired();
    if (this.lineSpacingExtra == null || this.lineSpacingExtra == undefined) {
      this.lineSpacingExtra = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetLineSpacingMultiplier = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getLineSpacingMultiplier = function () {
    if (this.lineSpacingMultiplier == null || this.lineSpacingMultiplier == undefined) {
      this.lineSpacingMultiplier = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.lineSpacingMultiplier.getCommandReturnValue();
  };
  EditTextImpl.prototype.setLineSpacingMultiplier = function (value) {
    this.resetIfRequired();
    if (this.lineSpacingMultiplier == null || this.lineSpacingMultiplier == undefined) {
      this.lineSpacingMultiplier = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setLines = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.tryGetMaxEms = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMaxEms = function () {
    if (this.maxEms == null || this.maxEms == undefined) {
      this.maxEms = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.maxEms.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMaxEms = function (value) {
    this.resetIfRequired();
    if (this.maxEms == null || this.maxEms == undefined) {
      this.maxEms = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetMaxHeight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMaxHeight = function () {
    if (this.maxHeight == null || this.maxHeight == undefined) {
      this.maxHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.maxHeight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMaxHeight = function (value) {
    this.resetIfRequired();
    if (this.maxHeight == null || this.maxHeight == undefined) {
      this.maxHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetMaxLines = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMaxLines = function () {
    if (this.maxLines == null || this.maxLines == undefined) {
      this.maxLines = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.maxLines.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMaxLines = function (value) {
    this.resetIfRequired();
    if (this.maxLines == null || this.maxLines == undefined) {
      this.maxLines = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetMaxWidth = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMaxWidth = function () {
    if (this.maxWidth == null || this.maxWidth == undefined) {
      this.maxWidth = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.maxWidth.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMaxWidth = function (value) {
    this.resetIfRequired();
    if (this.maxWidth == null || this.maxWidth == undefined) {
      this.maxWidth = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetMinEms = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMinEms = function () {
    if (this.minEms == null || this.minEms == undefined) {
      this.minEms = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.minEms.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMinEms = function (value) {
    this.resetIfRequired();
    if (this.minEms == null || this.minEms == undefined) {
      this.minEms = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetMinHeight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMinHeight = function () {
    if (this.minHeight == null || this.minHeight == undefined) {
      this.minHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.minHeight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMinHeight = function (value) {
    this.resetIfRequired();
    if (this.minHeight == null || this.minHeight == undefined) {
      this.minHeight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetMinLines = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMinLines = function () {
    if (this.minLines == null || this.minLines == undefined) {
      this.minLines = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.minLines.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMinLines = function (value) {
    this.resetIfRequired();
    if (this.minLines == null || this.minLines == undefined) {
      this.minLines = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetMinWidth = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getMinWidth = function () {
    if (this.minWidth == null || this.minWidth == undefined) {
      this.minWidth = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.minWidth.getCommandReturnValue();
  };
  EditTextImpl.prototype.setMinWidth = function (value) {
    this.resetIfRequired();
    if (this.minWidth == null || this.minWidth == undefined) {
      this.minWidth = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetPrivateImeOptions = function () {
    this.resetIfRequired();
    if (this.privateImeOptions == null || this.privateImeOptions == undefined) {
      this.privateImeOptions = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.getPrivateImeOptions = function () {
    if (this.privateImeOptions == null || this.privateImeOptions == undefined) {
      this.privateImeOptions = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.privateImeOptions.getCommandReturnValue();
  };
  EditTextImpl.prototype.setPrivateImeOptions = function (value) {
    this.resetIfRequired();
    if (this.privateImeOptions == null || this.privateImeOptions == undefined) {
      this.privateImeOptions = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setScrollHorizontally = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setSelectAllOnFocus = function (value) {
    this.resetIfRequired();
    if (this.selectAllOnFocus == null || this.selectAllOnFocus == undefined) {
      this.selectAllOnFocus = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetShadowColor = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getShadowColor = function () {
    if (this.shadowColor == null || this.shadowColor == undefined) {
      this.shadowColor = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.shadowColor.getCommandReturnValue();
  };
  EditTextImpl.prototype.setShadowColor = function (value) {
    this.resetIfRequired();
    if (this.shadowColor == null || this.shadowColor == undefined) {
      this.shadowColor = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetShadowDx = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getShadowDx = function () {
    if (this.shadowDx == null || this.shadowDx == undefined) {
      this.shadowDx = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.shadowDx.getCommandReturnValue();
  };
  EditTextImpl.prototype.setShadowDx = function (value) {
    this.resetIfRequired();
    if (this.shadowDx == null || this.shadowDx == undefined) {
      this.shadowDx = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetShadowDy = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getShadowDy = function () {
    if (this.shadowDy == null || this.shadowDy == undefined) {
      this.shadowDy = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.shadowDy.getCommandReturnValue();
  };
  EditTextImpl.prototype.setShadowDy = function (value) {
    this.resetIfRequired();
    if (this.shadowDy == null || this.shadowDy == undefined) {
      this.shadowDy = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetShadowRadius = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getShadowRadius = function () {
    if (this.shadowRadius == null || this.shadowRadius == undefined) {
      this.shadowRadius = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.shadowRadius.getCommandReturnValue();
  };
  EditTextImpl.prototype.setShadowRadius = function (value) {
    this.resetIfRequired();
    if (this.shadowRadius == null || this.shadowRadius == undefined) {
      this.shadowRadius = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setSingleLine = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.tryGetTextColor = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getTextColor = function () {
    if (this.textColor == null || this.textColor == undefined) {
      this.textColor = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.textColor.getCommandReturnValue();
  };
  EditTextImpl.prototype.setTextColor = function (value) {
    this.resetIfRequired();
    if (this.textColor == null || this.textColor == undefined) {
      this.textColor = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetTextColorHighlight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getTextColorHighlight = function () {
    if (this.textColorHighlight == null || this.textColorHighlight == undefined) {
      this.textColorHighlight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.textColorHighlight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setTextColorHighlight = function (value) {
    this.resetIfRequired();
    if (this.textColorHighlight == null || this.textColorHighlight == undefined) {
      this.textColorHighlight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setTextColorHint = function (value) {
    this.resetIfRequired();
    if (this.textColorHint == null || this.textColorHint == undefined) {
      this.textColorHint = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetTextIsSelectable = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.isTextIsSelectable = function () {
    if (this.textIsSelectable == null || this.textIsSelectable == undefined) {
      this.textIsSelectable = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.textIsSelectable.getCommandReturnValue();
  };
  EditTextImpl.prototype.setTextIsSelectable = function (value) {
    this.resetIfRequired();
    if (this.textIsSelectable == null || this.textIsSelectable == undefined) {
      this.textIsSelectable = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetTextScaleX = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getTextScaleX = function () {
    if (this.textScaleX == null || this.textScaleX == undefined) {
      this.textScaleX = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.textScaleX.getCommandReturnValue();
  };
  EditTextImpl.prototype.setTextScaleX = function (value) {
    this.resetIfRequired();
    if (this.textScaleX == null || this.textScaleX == undefined) {
      this.textScaleX = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetWidth = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getWidth = function () {
    if (this.width == null || this.width == undefined) {
      this.width = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.width.getCommandReturnValue();
  };
  EditTextImpl.prototype.setWidth = function (value) {
    this.resetIfRequired();
    if (this.width == null || this.width == undefined) {
      this.width = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setOnafterTextChange = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setOnbeforeTextChange = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setOnTextChange = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setOnEditorAction = function (value) {
    this.resetIfRequired();
    if (this.onEditorAction == null || this.onEditorAction == undefined) {
      this.onEditorAction = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setCapitalize = function (value) {
    this.resetIfRequired();
    if (this.capitalize == null || this.capitalize == undefined) {
      this.capitalize = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setPhoneNumber = function (value) {
    this.resetIfRequired();
    if (this.phoneNumber == null || this.phoneNumber == undefined) {
      this.phoneNumber = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setNumeric = function () {
    var value = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      value[_i] = arguments[_i];
    }
    ...
    if (this.numeric == null || this.numeric == undefined) {
      this.numeric = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    this.numeric.setSetter(true);
    this.numeric.setValue(value);
    this.orderSet++;
    this.numeric.setOrderSet(this.orderSet);
    this.numeric.setTransformer('numeric');
    return this.thisPointer;
  };
  EditTextImpl.prototype.setDigits = function (value) {
    this.resetIfRequired();
    if (this.digits == null || this.digits == undefined) {
      this.digits = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setEditorExtras = function (value) {
    this.resetIfRequired();
    if (this.editorExtras == null || this.editorExtras == undefined) {
      this.editorExtras = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setAutoText = function (value) {
    this.resetIfRequired();
    if (this.autoText == null || this.autoText == undefined) {
      this.autoText = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setTextAllCaps = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.selectAll = function (value) {
    ...
    if (this.selectAll_ == null || this.selectAll_ == undefined) {
      this.selectAll_ = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setHintTextFormat = function (value) {
    this.resetIfRequired();
    if (this.hintTextFormat == null || this.hintTextFormat == undefined) {
      this.hintTextFormat = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetText = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getText = function () {
    if (this.text == null || this.text == undefined) {
      this.text = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.text.getCommandReturnValue();
  };
  EditTextImpl.prototype.setText = function (value) {
    this.resetIfRequired();
    if (this.text == null || this.text == undefined) {
      this.text = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetTextSize = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getTextSize = function () {
    if (this.textSize == null || this.textSize == undefined) {
      this.textSize = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.textSize.getCommandReturnValue();
  };
  EditTextImpl.prototype.setTextSize = function (value) {
    this.resetIfRequired();
    if (this.textSize == null || this.textSize == undefined) {
      this.textSize = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setDrawableTop = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setDrawableBottom = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setMaxLength = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setTypeface = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setTextStyle = function () {
    var value = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      value[_i] = arguments[_i];
    }
  ...
  EditTextImpl.prototype.setFontFamily = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setPassword = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setEnabled = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setEditable = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setDrawableTint = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setDrawableTintMode = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setPadding = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.tryGetPaddingBottom = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getPaddingBottom = function () {
    if (this.paddingBottom == null || this.paddingBottom == undefined) {
      this.paddingBottom = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.paddingBottom.getCommandReturnValue();
  };
  EditTextImpl.prototype.setPaddingBottom = function (value) {
    this.resetIfRequired();
    if (this.paddingBottom == null || this.paddingBottom == undefined) {
      this.paddingBottom = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetPaddingRight = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getPaddingRight = function () {
    if (this.paddingRight == null || this.paddingRight == undefined) {
      this.paddingRight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.paddingRight.getCommandReturnValue();
  };
  EditTextImpl.prototype.setPaddingRight = function (value) {
    this.resetIfRequired();
    if (this.paddingRight == null || this.paddingRight == undefined) {
      this.paddingRight = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetPaddingLeft = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getPaddingLeft = function () {
    if (this.paddingLeft == null || this.paddingLeft == undefined) {
      this.paddingLeft = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.paddingLeft.getCommandReturnValue();
  };
  EditTextImpl.prototype.setPaddingLeft = function (value) {
    this.resetIfRequired();
    if (this.paddingLeft == null || this.paddingLeft == undefined) {
      this.paddingLeft = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetPaddingStart = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getPaddingStart = function () {
    if (this.paddingStart == null || this.paddingStart == undefined) {
      this.paddingStart = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.paddingStart.getCommandReturnValue();
  };
  EditTextImpl.prototype.setPaddingStart = function (value) {
    this.resetIfRequired();
    if (this.paddingStart == null || this.paddingStart == undefined) {
      this.paddingStart = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetPaddingEnd = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getPaddingEnd = function () {
    if (this.paddingEnd == null || this.paddingEnd == undefined) {
      this.paddingEnd = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.paddingEnd.getCommandReturnValue();
  };
  EditTextImpl.prototype.setPaddingEnd = function (value) {
    this.resetIfRequired();
    if (this.paddingEnd == null || this.paddingEnd == undefined) {
      this.paddingEnd = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.tryGetPaddingTop = function () {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.getPaddingTop = function () {
    if (this.paddingTop == null || this.paddingTop == undefined) {
      this.paddingTop = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
    return this.paddingTop.getCommandReturnValue();
  };
  EditTextImpl.prototype.setPaddingTop = function (value) {
    this.resetIfRequired();
    if (this.paddingTop == null || this.paddingTop == undefined) {
      this.paddingTop = new _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  ...
  EditTextImpl.prototype.setPaddingHorizontal = function (value) {
    this.resetIfRequired();
  ...
  EditTextImpl.prototype.setPaddingVertical = function (value) {
    this.resetIfRequired();
  ...
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_6__.Exclude)(), __metadata("design:type", Object)], EditTextImpl.prototype, "thisPointer", void 0);
  return EditTextImpl;
...
var EditText = /** @class */function (_super) {
  ...
  function EditText(id, path, event) {
    return _super.call(this, id, path, event) || this;
  }
  EditText.prototype.getThisPointer = function () {
    return this;
  };
  EditText.prototype.getClass = function () {
    return EditText;
  };
  return EditText;
}(EditTextImpl);
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/esm5/decorators/expose.decorator.js");
...
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! babel-polyfill */ "./node_modules/babel-polyfill/lib/index.js");
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ViewGroupImpl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ViewGroupImpl */ "./src/android/widget/ViewGroupImpl.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
// start - imports
var __extends = undefined && undefined.__extends || function () {
  var _extendStatics = function extendStatics(d, b) {
...
var FrameLayoutImpl = /** @class */function (_super) {
  ...
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_5__.Exclude)(), __metadata("design:type", Object)], FrameLayoutImpl.prototype, "thisPointer", void 0);
  return FrameLayoutImpl;
}(_ViewGroupImpl__WEBPACK_IMPORTED_MODULE_2__.ViewGroupImpl);
...
var FrameLayoutImpl_LayoutParams = /** @class */function (_super) {
  ...
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_5__.Exclude)(), __metadata("design:type", Object)], FrameLayoutImpl_LayoutParams.prototype, "thisPointer", void 0);
  return FrameLayoutImpl_LayoutParams;
}(_ViewGroupImpl__WEBPACK_IMPORTED_MODULE_2__.ViewGroupImpl_LayoutParams);
...
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _widget_TransformerFactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../widget/TransformerFactory */ "./src/widget/TransformerFactory.ts");
/* harmony import */ var _ViewGroupModelImpl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ViewGroupModelImpl */ "./src/android/widget/ViewGroupModelImpl.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
// start - imports
var __extends = undefined && undefined.__extends || function () {
  var _extendStatics = function extendStatics(d, b) {
...
var ViewGroupImpl = /** @class */function (_super) {
  ...
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_6__.Exclude)(), __metadata("design:type", Object)], ViewGroupImpl.prototype, "thisPointer", void 0);
  return ViewGroupImpl;
}(_ViewGroupModelImpl__WEBPACK_IMPORTED_MODULE_3__.ViewGroupModelImpl);
...
var ViewGroupImpl_LayoutParams = /** @class */function () {
  ...
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_6__.Exclude)(), __metadata("design:type", Object)], ViewGroupImpl_LayoutParams.prototype, "thisPointer", void 0);
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_6__.Exclude)(), __metadata("design:type", Number)], ViewGroupImpl_LayoutParams.prototype, "orderGet", void 0);
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_6__.Exclude)(), __metadata("design:type", Number)], ViewGroupImpl_LayoutParams.prototype, "orderSet", void 0);
...
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! babel-polyfill */ "./node_modules/babel-polyfill/lib/index.js");
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ViewImpl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ViewImpl */ "./src/android/widget/ViewImpl.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
// start - imports
var __extends = undefined && undefined.__extends || function () {
  var _extendStatics = function extendStatics(d, b) {
...
/* harmony import */ var _widget_CommandAttr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../widget/CommandAttr */ "./src/widget/CommandAttr.ts");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/esm5/decorators/expose.decorator.js");
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/esm5/decorators/transform.decorator.js");
...
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/esm5/decorators/exclude.decorator.js");
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! babel-polyfill */ "./node_modules/babel-polyfill/lib/index.js");
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _widget_TransformerFactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../widget/TransformerFactory */ "./src/widget/TransformerFactory.ts");
...
var ViewImpl_performHapticFeedbackWithFlags = /** @class */function () {
  ...
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_4__.Expose)({
    name: "value"
  }), __metadata("design:type", String)], ViewImpl_performHapticFeedbackWithFlags.prototype, "value", void 0);
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_4__.Expose)({
    name: "flags"
  }), (0,class_transformer__WEBPACK_IMPORTED_MODULE_5__.Transform)(function (_a) {
    var value = _a.value,
      obj = _a.obj,
      type = _a.type;
...
var Fragment = /** @class */function () {
  ...
  Fragment.prototype.executeInternalCommand = function (commands) {
    return new Promise(function (resolve, reject) {
      coreManager.executeCommand((0,class_transformer__WEBPACK_IMPORTED_MODULE_2__.serialize)(commands), function (result) {
        resolve(result);
      });
    });
  };
...
/* harmony import */ var _app_ScopedObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../app/ScopedObject */ "./src/app/ScopedObject.ts");
var __awaiter = undefined && undefined.__awaiter || function (thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function (resolve) {
      resolve(value);
...
var NavController = /** @class */function () {
  ...
  NavController.prototype.navigate = function (actionId, varExpression, data) {
    this.navigateTo(actionId, new _app_ScopedObject__WEBPACK_IMPORTED_MODULE_0__.ScopedObject(varExpression, data));
    return this;
  };
  NavController.prototype.navigateWithPopBackStack = function (actionId) {
    ...
    this.commands.push(["navigateWithPopBackStack", actionId, (0,class_transformer__WEBPACK_IMPORTED_MODULE_1__.classToPlain)(scopedObjects)]);
    return this;
  };
  NavController.prototype.navigateAsTop = function (actionId) {
    ...
    this.commands.push(["navigateAsTop", actionId, (0,class_transformer__WEBPACK_IMPORTED_MODULE_1__.classToPlain)(scopedObjects)]);
    return this;
  };
  NavController.prototype.navigateWithPopBackStackTo = function (actionId, destinationId, inclusive) {
    ...
    this.commands.push(["navigateWithPopBackStackTo", actionId, destinationId, inclusive, (0,class_transformer__WEBPACK_IMPORTED_MODULE_1__.classToPlain)(scopedObjects)]);
    return this;
  };
  NavController.prototype.navigateTo = function (actionId) {
    ...
    this.commands.push(["navigate", actionId, (0,class_transformer__WEBPACK_IMPORTED_MODULE_1__.classToPlain)(scopedObjects)]);
    return this;
  };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var class_transformer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! class-transformer */ "./node_modules/class-transformer/esm5/decorators/transform.decorator.js");
...
var CommandAttr = /** @class */function () {
  ...
  __decorate([(0,class_transformer__WEBPACK_IMPORTED_MODULE_2__.Transform)(function (_a) {
    var value = _a.value,
      obj = _a.obj,
      type = _a.type;
...
var TransformOperationExecutor = /** @class */function () {
  ...
  TransformOperationExecutor.prototype.transform = function (source, value, targetType, arrayType, isMap, level) {
    ...
    if (Array.isArray(value) || value instanceof Set) {
      var newValue_1 = arrayType && this.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.PLAIN_TO_CLASS ? instantiateArrayType(arrayType) : [];
      ...
      if (!source && (this.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.PLAIN_TO_CLASS || this.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.CLASS_TO_CLASS)) {
        if (isMap) {
          newValue = new Map();
        } else if (targetType) {
      ...
      var _loop_1 = function _loop_1(key) {
        ...
        if (!this_1.options.ignoreDecorators && targetType) {
          ...
          } else if (this_1.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.CLASS_TO_PLAIN || this_1.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.CLASS_TO_CLASS) {
        ...
        if (targetType && isMap) {
          ...
          } else if (this_1.options.enableImplicitConversion && this_1.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.PLAIN_TO_CLASS) {
        ...
        if (newValue.constructor.prototype) {
          ...
          if ((this_1.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.PLAIN_TO_CLASS || this_1.transformationType === _enums__WEBPACK_IMPORTED_MODULE_0__.TransformationType.CLASS_TO_CLASS) && (
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ErrorFragment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ErrorFragment */ "./src/ErrorFragment.ts");
/* harmony import */ var _FragmentFactory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FragmentFactory */ "./src/FragmentFactory.ts");
/* harmony import */ var _app_LocaleManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app/LocaleManager */ "./src/app/LocaleManager.ts");
...
var App = /** @class */function () {
  function App() {
    ...
    this.errorFragment = new _ErrorFragment__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this.fragmentFactory = new _FragmentFactory__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this.localManager = _app_LocaleManager__WEBPACK_IMPORTED_MODULE_2__["default"].getInstance();
  }
